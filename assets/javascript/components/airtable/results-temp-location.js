    ...
    get_types:() => {
        ...
        return $.ajax({
            ...
            beforeSend: function (xhr) {
                xhr.setRequestHeader("Authorization", "Bearer " + "keyAfVmMUTmD1AXwR");
            },
            type: 'GET',
            dataType: 'json',
...
airtable = {
    get_types:() => {
        ...
        return $.ajax({
            url: "https://api.airtable.com/v0/appDF3pRKj0e84Foy/Types?view=Grid%20view&fields%5B%5D=Election+Type",
            beforeSend: function (xhr) {
    ...
    get_roles: (type) => {
        ...
        return $.ajax({
            url: "https://api.airtable.com/v0/appDF3pRKj0e84Foy/Roles?view=Grid%20view&fields%5B%5D=Role&filterByFormula=" + urlAppend,
            beforeSend: function (xhr) {
                xhr.setRequestHeader("Authorization", "Bearer " + "keyKrzjJcoeMnIAKY");
            },
            type: 'GET',
    ...
    get_candidates: (role) => {
        ...
        return $.ajax({
            url: "https://api.airtable.com/v0/appDF3pRKj0e84Foy/Candidates?view=Grid%20view&filterByFormula=" + urlAppend,
            beforeSend: function (xhr) {
                xhr.setRequestHeader("Authorization", "Bearer " + "keyKrzjJcoeMnIAKY");
            },
            type: 'GET',
